...
!b::
    ClickComponent("input")
    SendInput, Уважаемый игрок, чтобы разблокировать функционал передачи, пожалуйста напишите на почту support@gta5rp.com с Вашего email, который привязан к аккаунту GTA5RP{!}
return
